...
class RuntimeScriptTests(unittest.TestCase):
    ...
    def test_uu_terminal_uses_authenticated_native_pty_bridge(self):
        ...
        self.assertIn("uu-terminal.inputrc", builder)
        ...
        self.assertIn("resources/uu-terminal.inputrc", digest)
        ...
        self.assertIn("UURB_NATIVE_TERMINAL", native)
        self.assertIn("PROMPT_DIRTRIM", native)
        self.assertIn('setenv("TERM", "xterm-256color", 1)', native)
        self.assertIn('unsetenv("VTE_VERSION")', native)
        self.assertIn("PROMPT_COMMAND", native)
        self.assertIn("uu-terminal.inputrc", native)
        self.assertIn('execl(shell, shell, "-i"', native)
        self.assertIn("uu-terminal.inputrc", installer)
        self.assertIn("uu-terminal.inputrc", launcher)
        self.assertIn("uu-terminal.inputrc", verifier)
